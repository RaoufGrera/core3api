...
function Card(props) {
  ...
  const { content, stampId, id, senderId, senderName, messageNumber, ago, messageAgo } = objs[i];
      ...
      >
        ...
        >
          ...
          <div className="card-last max-message">
            ...
            <div className="p-3 pb-0"><p className="text-black-100 fw-bold ">{senderName}</p>
