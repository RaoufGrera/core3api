                            ...
                            {users && myProfile && profileData && users.map(user =>
                                ...
                                <div className="col-lg-4 p-3">
                                    <div className="card h-100 shadow-sm">
                                        <div className="text-center p-2 card-bg" href={"/profile/" + user.id}>
                                        ...
                                        <div className="card-body mt-15">
                                            ...
                                            <div className="my-2 text-center">
                                                <h1 > {user.name}  <span className={(user.username == session) ? "dot green" : "dot gray"}></span></h1>
